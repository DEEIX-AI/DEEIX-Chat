...
var exactErrorSpecs = map[string]errorSpec{
	...
	"default role must be user or superadmin":                     {Code: "auth.provider_default_role_invalid", Message: "default role must be user or superadmin"},
	...
	"superadmin role change not allowed":      {Code: "user.superadmin_role_protected", Message: "superadmin role change is not allowed"},
	...
	"superadmin already exists":               {Code: "user.superadmin_already_exists", Message: "superadmin already exists"},
...
var fallbackMessages = map[string]string{
	...
	"auth.provider_default_role_invalid":        "default role must be user or superadmin",
