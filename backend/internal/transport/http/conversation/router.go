...
func (m *Module) RegisterRoutes(authRequired *gin.RouterGroup) {
	...
	authRequired.GET("/conversations/:id/acl", m.Handler.ListConversationACL)
	authRequired.PUT("/conversations/:id/acl", m.Handler.GrantConversationACL)
	authRequired.DELETE("/conversations/:id/acl/:grantee_user_id", m.Handler.RevokeConversationACL)
