...
| 协议与适配 | 统一适配 OpenAI、Anthropic、Google/Gemini、xAI、OpenRouter、Requesty 和 OpenAI 兼容协议，覆盖文本、图片、工具和不同厂商的原生能力差异。 |
...
flowchart TB
  ...
  subgraph External["外部能力"]
    Providers["模型服务商<br/>OpenAI / Anthropic / Google / xAI / OpenRouter / Requesty"]
